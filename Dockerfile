...
# Copiar únicamente los archivos necesarios para producción asignando ownership
...
# Comando de inicio usando servidor de producción Gunicorn
CMD ["gunicorn", "--bind", "0.0.0.0:5000", "--workers", "2", "--threads", "2", "--timeout", "60", "--access-logfile", "-", "--error-logfile", "-", "src.app:app"]
