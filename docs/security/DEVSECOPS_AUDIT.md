...
| **Rotación de Credenciales** | Rotación periódica (60/90 días) y de emergencia con ExternalSecret y Stakater Reloader (formalizado en [secret-rotation.md](../operations/secret-rotation.md)) | Implementado | Reducción de la ventana de exposición ante fugas y recargas automáticas sin downtime. |
