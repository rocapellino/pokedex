...
| **Bastion Host (LXC 820)** | Punto único de entrada administrativa (Management Plane), sesión interactiva restringida, auditoría inmutable de comandos y ejecución de *Break-Glass*. | On-prem (10.10.13.120) | **Sí** | Si se elimina, los operadores accederían directamente a los nodos de cómputo y clúster K8s sin registro de auditoría (`/var/log/bastion/audit.log`), violando Zero-Trust. |
