...
3. [Catálogo de Workflows del Proyecto](#3-catálogo-de-workflows-del-proyecto)
   * [3.1. ⚙️ `api.yml` (Backend API CI)](#31-️-apiyml-backend-api-ci)
   ...
   * [3.6. 🛡️ `security-trivy.yml` (Escaneo Programado de Vulnerabilidades)](#36-️-security-trivyyml-escaneo-programado-de-vulnerabilidades)
   * [3.7. 🏷️ `release-tag.yml` (Versionado Semántico Automático)](#37-️-release-tagyml-versionado-semántico-automático)
   * [3.8. ⚡ `performance-k6.yml` (Pruebas de Carga y Rendimiento)](#38--performance-k6yml-pruebas-de-carga-y-rendimiento)
