...
* **¿Qué hace paso a paso?**
  ...
  2. Instala Python 3.11 y las dependencias de `requirements.txt`.
  3. Ejecuta **Ruff** para verificar que no haya errores de sintaxis, variables sin usar o patrones lentos.
  4. Ejecuta la suite de **14 pruebas unitarias con Pytest** (`pytest apps/api/tests/`).
* **Objetivo:** Garantizar que los endpoints REST de FastAPI, la conexión a la base de datos y la serialización Pydantic funcionen al 100%.
