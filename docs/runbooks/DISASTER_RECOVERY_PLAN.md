...
| **Off-Site Google Drive (Proxmox)** | Hipervisor (Proxmox VE) | **MECANISMO EN HOST (DESACOPLADO)** | Rclone + Systemd en host; requiere puente desde `pokedex-backup-pvc` (Ver [GDRIVE_BACKUP_GUIDE.md](../operations/GDRIVE_BACKUP_GUIDE.md)) |
