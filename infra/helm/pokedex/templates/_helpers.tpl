...
Common labels
*/}}
{{- define "pokedex.labels" -}}
helm.sh/chart: {{ include "pokedex.chart" . }}
{{ include "pokedex.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/part-of: pokemon-platform
{{- end }}

{{/*
Selector labels
*/}}
{{- define "pokedex.selectorLabels" -}}
